"""
Provides plugin services to the client1
...
# Entry point group.
PLUGINS_ENTRY_POINT_GROUP = "client1.plugins"

# Entry point for test plugins.
TEST_PLUGINS_ENTRY_POINT_GROUP = "client1.test_plugins"
...
def load_all(settings):
    """
    Load all plugins listed in the 'client1.plugins' settings variable.
