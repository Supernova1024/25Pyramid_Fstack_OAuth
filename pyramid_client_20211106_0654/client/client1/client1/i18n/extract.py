...
import client1.config.jinja_extensions as je

jinja_extensions = """
                    jinja2.ext.do,jinja2.ext.i18n,                    
                    client1.config.jinja_extensions:JSResourceExtension,
                    client1.config.jinja_extensions:CSSResourceExtension,
                    client1.config.jinja_extensions:ExtendThis,
                   """
...
def extract_client1(fileobj, *args, **kw):
