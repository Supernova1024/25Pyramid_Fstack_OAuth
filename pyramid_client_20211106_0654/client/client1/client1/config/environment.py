...
import client1.plugins.helpers as helpers
import client1.resources as r
from client1.models import add_column_to_schema
...
def __url_for_static(request, static_file, library="client1_static"):
    """
...
def load_environment(settings, config, apppath, policy_array):
    ...
    # config.add_translation_dirs("client1:locale")
    config.add_subscriber(
        "client1.i18n.i18n.add_renderer_globals", "pyramid.events.BeforeRender"
    )
    config.add_subscriber("client1.i18n.i18n.add_localizer", "pyramid.events.NewRequest")
    ...
    config.add_static_view("client1_static", static_path, cache_max_age=3600)
    ...
    # Call any connected plugins to update client1 ORM. For example: Add new tables
